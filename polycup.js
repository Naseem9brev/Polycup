...
function startPrompt(elo, odds, rho, favorites, bracket, initialPlayerModel, initialPenaltyModel, initialMatchXgModel) {
...
async function main() {
  ...
  startPrompt(elo, odds, effectiveRho, favorites, bracket, null, penaltyModel, initialMatchXgModel);
}
